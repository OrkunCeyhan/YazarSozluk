...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator:AbstractValidator<Writer>
    {
        ...
        {
            RuleFor(x => x.WriterName).NotEmpty().WithMessage("Yazar adını bol geçemezsiniz");
            ...
            RuleFor(x => x.WriterSurName).MaximumLength(50).WithMessage("Lütfen 50 karakteri geçmeyin");
        }
    }
}
